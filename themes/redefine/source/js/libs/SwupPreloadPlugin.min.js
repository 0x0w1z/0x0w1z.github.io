!(function (e, t) {
  ...
  class r {
    ...
    _checkRequirements() {
      return (
        "object" != typeof this.requires ||
          Object.entries(this.requires).forEach(([e, r]) => {
            if (
              !(function (e, r, o) {
                const s = (function (e, t) {
                  ...
                  if ("swup" === e) return null != (r = t.version) ? r : "";
                  {
                    ...
                    return null != (o = null == r ? void 0 : r.version)
                      ? o
                      : "";
                  }
                })(e, o);
              ...
              })(e, (r = Array.isArray(r) ? r : [r]), this.swup)
            ) {
              const t = `${e} ${r.join(", ")}`;
              throw new Error(
    ...
    on(e, t, r = {}) {
      var o;
      t =
        !(o = t).name.startsWith("bound ") || o.hasOwnProperty("prototype")
          ? t.bind(this)
          : t;
      const s = this.swup.hooks.on(e, t, r);
      return this.handlersToUnregister.push(s), s;
    }
    once(t, r, o = {}) {
      return this.on(t, r, e({}, o, { once: !0 }));
    }
    before(t, r, o = {}) {
      return this.on(t, r, e({}, o, { before: !0 }));
    }
    replace(t, r, o = {}) {
      return this.on(t, r, e({}, o, { replace: !0 }));
    }
    off(e, t) {
  ...
  const o = ({ hash: e } = {}) =>
    location.pathname + location.search + (e ? location.hash : "");
  class s extends URL {
  ...
  return class extends r {
    constructor(e) {
      ...
      (this.name = "SwupPreloadPlugin"),
        ...
        (this.onMouseEnter = function (e) {
          try {
            if (e.target !== e.delegateTarget) return Promise.resolve();
            if (!i()) return Promise.resolve();
            const r = e.delegateTarget;
            return r instanceof HTMLAnchorElement
              ? (t.swup.hooks.callSync("link:hover", { el: r, event: e }),
        ...
        (this.onTouchStart = (e) => {
          ...
          t instanceof HTMLAnchorElement && this.preload(t, { priority: !0 });
        }),
        (this.onFocus = (e) => {
          const t = e.delegateTarget;
          t instanceof HTMLAnchorElement && this.preload(t, { priority: !0 });
        });
      const { preloadVisibleLinks: r, ...o } = e;
      (this.options = { ...this.defaults, ...o }),
        "object" == typeof r
        ...
        (this.queue = (function (e) {
          ...
          return {
            add: function (e, s) {
              ...
              (e.__queued = !0), (s ? r : t).push(e), o++, o <= 1 && i();
            },
            next: function () {
              s--, i();
            },
    ...
    mount() {
      ...
      const { linkSelector: t } = e.options,
      ...
      (this.mouseEnterDelegate = e.delegateEvent(
        ...
        this.options.preloadInitialPage && this.preload(o());
    }
    unmount() {
    ...
    preload(e, t) {
      ...
      try {
        const r = this;
        let o, i;
        const n = t.priority ?? !1;
        if (Array.isArray(e)) return Promise.all(e.map((e) => r.preload(e)));
        if (e instanceof HTMLAnchorElement)
          (i = e), ({ url: o } = s.fromElement(e));
        else {
          if ("string" != typeof e) return Promise.resolve();
          o = e;
        }
        if (r.preloadPromises.has(o))
          return Promise.resolve(r.preloadPromises.get(o));
        if (!r.shouldPreload(o, { el: i })) return Promise.resolve();
        const a = new Promise((e) => {
          r.queue.add(() => {
            r.performPreload(o)
              ...
              .then((t) => e(t))
              .finally(() => {
                r.queue.next(), r.preloadPromises.delete(o);
              });
          }, n);
        });
        return r.preloadPromises.set(o, a), Promise.resolve(a);
      } catch (e) {
        return Promise.reject(e);
      }
    }
    ...
    preloadVisibleLinks() {
      ...
      (this.preloadObserver = (function (e) {
        let {
          threshold: t,
          delay: r,
          containers: o,
        ...
        const a = new Map(),
          l = new IntersectionObserver(
            (e) => {
              e.forEach((e) => {
                e.isIntersecting ? h(e.target) : u(e.target);
              });
            },
            { threshold: t }
          ),
          h = (e) => {
            const t = a.get(e.href) ?? new Set();
            a.set(e.href, t),
              t.add(e),
              setTimeout(() => {
                const t = a.get(e.href);
                t?.size && (s(e), l.unobserve(e), t.delete(e));
              }, r);
          },
          u = (e) => a.get(e.href)?.delete(e),
          c = () => {
            n(() => {
              const e = o.map((e) => `${e} a[href]`).join(", ");
    ...
    shouldPreload(e, t) {
      let { el: r } = void 0 === t ? {} : t;
      const { url: i, href: n } = s.fromUrl(e);
      return !(
        !(function () {
          if (navigator.connection) {
            if (navigator.connection.saveData) return !1;
            if (navigator.connection.effectiveType?.endsWith("2g")) return !1;
          }
          return !0;
        })() ||
        this.swup.cache.has(i) ||
        this.preloadPromises.has(i) ||
        this.swup.shouldIgnoreVisit(n, { el: r }) ||
        (r && this.swup.resolveUrl(i) === this.swup.resolveUrl(o()))
      );
    }
    performPreload(e) {
      try {
        const t = this;
        return Promise.resolve(t.swup.fetchPage(e)).then(function (e) {
          return Promise.resolve(
            t.swup.hooks.call("page:preload", { page: e })
          ).then(function () {
            return e;
          });
        });
